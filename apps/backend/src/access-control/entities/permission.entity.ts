...
export class Permission {
  ...
  @ApiPropertyOptional({
    description:
      'Resource/entity type that this permission applies to (e.g., products, orders, users)',
    example: 'products',
    type: 'string',
    nullable: true,
    maxLength: 50,
  ...
  @ApiPropertyOptional({
    description:
      'Action/operation type (e.g., view, create, edit, delete, manage, export, import)',
    example: 'view',
    type: 'string',
    nullable: true,
    maxLength: 50,
  ...
  @ApiProperty({
    description:
      'Indicates if this is a system-level permission that cannot be deleted (protects critical permissions)',
    example: false,
    default: false,
    type: 'boolean',
  })
  ...
  @ApiPropertyOptional({
    description:
      'Legacy category field (use resource and action fields for new implementations)',
    example: 'products',
    type: 'string',
    nullable: true,
    deprecated: true,
